...
This web app: **I made a replica of the example site given to us. This app allows one to add to their crew, update crewmates and delete crew mates. I used Superbase for the storage of the data used on my site**
...
* [X] added responsiveness and page not found animations
...
I had a bit of challenges with the view page sizing
